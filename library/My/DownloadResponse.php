...
/**
 * A Response class that sends files to the client.
*/
class My_DownloadResponse extends Zend_Controller_Response_Http {
     ...
     *
     * $file_data is an associative array as returned by the {@link Skylable_AccessSx::getFileInfo }
     * method.
     *
     ...
     */
    public function __construct(Skylable_AccessSx $access_sx, $file_data, $password = '', $purge_dir = '', $content_disposition = Skylable_AccessSx::DOWNLOAD_DISPOSITION_ATTACHMENT) {
