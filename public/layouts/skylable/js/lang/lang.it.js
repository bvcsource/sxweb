...
if (!Skylable_Lang) {
    var Skylable_Lang = {
        ...
        noFilesSelected : "Impossibile continuare: nessun file selezionato.",
        ...
        createDirTitle: "Crea cartella",

        // Create dir "create" button
        createDirBtn: "Crea",

        // Input form label
        createDirNameLabel : "Nome cartella:",

        // ------------ Copy window
        copyTitle: "Copia file",
        copyBtn : "Copia!",

        // ------------ Move window
        moveTitle: "Sposta file",
        moveBtn : "Sposta!",
        ...
        // --------- Delete window
        deleteTitle : "Cancella file",
        deleteMsg: "Sei sicuro di voler cancellare il file selezionato?",
        deleteNoFiles: "Nessun file selezionato",
        ...
        // --------- Manage volume
        managevolumeChangeUserPrivilegesWTitle: "Cambia i privilegi",
        managevolumeChangeUserPrivileges: "Cambia i privilegi per l'utente:",
        managevolumePrivileges: "Privilegi:",
        managevolumePrivRead : "Lettura",
        managevolumePrivWrite : "Scrittura",
