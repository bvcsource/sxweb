...
class Application_Form_CreateAccount extends Zend_Form {
    public function init() {
        $this->addElement( 
                $this->createElement('text', 'frm_email')
        ...
        $this->addElement(
                $this->createElement('password', 'frm_password')
        ...
        $this->addElement(
            $this->createElement('password', 'frm_passwordv')
                ->addValidator(new Zend_Validate_Identical( 'frm_password' ))
                ->setRequired(TRUE)
                ->addErrorMessage("Passwords mismatch")
                ->setLabel('Confirmation Password')
        );
        
        $this->addElement(
            $this->createElement('text', 'frm_user_key')
