...
class AjaxController extends My_BaseAction {
     ...
     * 'raw' - if set the file will be sent inline
     */
    public function sharedActionOK() {
        ...
        $is_inline = is_null($this->getRequest()->getParam('raw'));
               ...
               // Show the info window
                ...
                if ($allow_download) {
                    ...
                    $res = new My_DownloadResponse($access_sx, $the_file, '', (isset($base_dir) ? $base_dir : '' ), 
                        ($is_inline ? Skylable_AccessSxNew::DOWNLOAD_DISPOSITION_ATTACHMENT : Skylable_AccessSxNew::DOWNLOAD_DISPOSITION_INLINE) );
